...
.h100{background:#B8E4D0;color:#2D6A4F;}.h75{background:#F5E7B5;color:#8A6A10;}.h50{background:#F4E1A6;color:#A97B12;}.h25{background:#F6D9D9;color:#9B3B3B;}.h0{background:#F0C8C8;color:#8B2B2B;}.hna{background:#F8F9FB;color:#C4CAD4;font-family:'Inter',sans-serif;font-weight:500;font-size:11px;}
