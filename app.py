...
with tab1:
    ...
    df1 = filt(filt(filt_mes(df_base, sel_mes), "ETAPA", sel_etapa, "Todas"), "Proyecto", sel_proy, "Todos")
    ...
    mp = (df1.groupby("Mes").size()
            .reindex(MESES_VENCIDOS, fill_value=0).reset_index())
    mp.columns = ["Mes","n"]
    fig_line = go.Figure()
...
with tab4:
    ...
    df4 = filt(filt(filt_mes(filt(filt(filt(df_base,
